        ...
        <div class="card-body">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a type="button" href="{{ route('pelanggan.pembayaran.create',$item->id_tagihan) }}" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#store_data-{{ $item->id_tagihan}}">
            ...
            @foreach ($data_tagihan as $data )
                ...
                <div class="modal fade" id="store_data-{{ $data->id_tagihan }}" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('pelanggan.pembayaran.store',$data->id_tagihan) }}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
