    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <tr>
                ...
                <td>{{ $item->status }}</td>
                <td>
                    <a type="button" href="{{ route('kasir.detail.pembayaran.tunai',$item->id_tagihan) }}" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#show_data-{{ $item->id_tagihan}}">
                        Bayar Tagihan
                    </a>
                </td>
            </tr>       
            ...
            <div class="modal fade" id="show_data-{{ $data->id_tagihan }}" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('kasir.pembayaran.paid', $data->id_tagihan)}}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row m-2">
                            ...
                            <div class="row mb-3 m-2">
                                <label for="tunai" class="col-sm-12 col-form-label">Tunai</label>
                                <div class="col-sm-12">
                                    <input type="number" name="tunai" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3 m-2">
                                <label for="tanggal_pembayaran" class="col-sm-12 col-form-label">Tanggal Pembayaran</label>
                                <div class="col-sm-12">
                                    <input type="date" name="tanggal_pembayaran" class="form-control" id="bulan_penggunaan"id="tanggal_pembayaran">
                                </div>
                            </div>                        
