        ...
        <div class="card">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#show_bukti_pembayaran-{{ $item->id_tagihan}}">
                        Bukti Pembayaran
                    </a>
                    <form action="{{ route('kasir.pembayaran.approved',$item->id_tagihan) }}" method="POST" style="display: inline;">
                        @method('PUT')
                        @csrf
                    ...
                    <form action="{{ route('kasir.pembayaran.declined',$item->id_tagihan) }}" method="POST" style="display: inline;">
                        @method('PUT')
                        @csrf
            ...
            <div class="modal fade" id="show_data-{{ $data->id_tagihan }}" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('kasir.daftar.detail.pembayaran', $data->id_tagihan)}}" method="get">
                            @method('GET')
                            @csrf
                            <div class="row m-2">
                            ...
                            <div class="row m-2">
                                <label for="id_pelanggan" class="col-sm-12 col-form-label">Id Tagihan</label>
                                <div class="col-sm-12">
                                    <p> {{ $data->id_tagihan }}</p>
                                </div>
                            </div>
            ...
            <!-- Modal for Show Bukti Pembayaran -->
            <div class="modal fade" id="show_bukti_pembayaran-{{ $data->id_tagihan }}" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    ...
                    <div class="modal-body">
                        <!-- General Form Elements -->
                        <h5 class="card-title mx-3">Data Bukti Pembayaran</h5>
                        <form action="{{ route('kasir.bukti.pembayaran', $data->id_tagihan)}}" method="get">
                            @method('GET')
                            @csrf
                            <div class="row m-2">
                                <div class="col-sm-12">
                                    @if ($data->pembayaran)
                                        <img src="{{ asset($data->pembayaran->bukti_pembayaran) }}" alt="" class="img-fluid">
                                    @else
            ...
            </div> <!-- End Modal for Show Bukti Pembayaran -->   
        @endforeach
            </tbody>
            </table>
